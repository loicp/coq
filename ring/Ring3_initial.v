...
Instance Zr: (@Ring Z Z0 (Zpos xH) Zplus Zmult Zminus Zopp (@eq Z)).
constructor;
try (try apply Zsth;
try (unfold respectful, Proper; unfold equality; intros; try rewrite H; try rewrite H0; reflexivity)).
